...
export const getCurriculumScheduleItems = async (year: number): Promise<CurriculumScheduleItem[]> => {
  ...
  const items = snapshot.docs
    .map((doc) => ({ id: doc.id, ...doc.data() } as CurriculumScheduleItem))
...
export const getCurriculumScheduleByMonth = async (
  ...
  const items = await getCurriculumScheduleItems(year);
  ...
  if (existingData.linkedEventId) {
    try {
      await updateSchoolEvent(existingData.linkedEventId, {
        ...
        endDate: data.endDate || existingData.endDate || undefined,
        description: `${data.subject || existingData.subject}${(data.notes || existingData.notes) ? ' | ' + (data.notes || existingData.notes) : ''}`,
      });
    } catch (e) {
      console.warn('Failed to update linked event:', e);
    }
  }
};
...
export const INITIAL_SCHEDULE_DATA: Omit<CurriculumScheduleItem, 'id' | 'year' | 'createdAt' | 'updatedAt' | 'updatedBy' | 'linkedEventId'>[] = [
  { month: 3, startDate: '2026-03-03', endDate: '', activityName: '시업식(1교시)', gradeHours: { grade1: null, grade2: 1, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '창체(자율자치)', notes: '2~6학년 4교시 편성(급식 실시)' },
  { month: 3, startDate: '2026-03-03', endDate: '', activityName: '입학식(2교시)', gradeHours: { grade1: 2, grade2: null, grade3: null, grade4: null, grade5: null, grade6: null }, subject: '창체(자율자치)', notes: '1학년 2교시 편성(급식 미실시)' },
  ...
  { month: 3, startDate: '2026-03-09', endDate: '', activityName: '1학기 학급임원선거', gradeHours: { grade1: null, grade2: null, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '창체(자율자치)', notes: '' },
  ...
  { month: 3, startDate: '2026-03-11', endDate: '', activityName: '진단평가', gradeHours: { grade1: null, grade2: 2, grade3: 2, grade4: 2, grade5: 2, grade6: 2 }, subject: '교과(국1, 수1)', notes: '1~2교시 편성' },
  ...
  { month: 3, startDate: '2026-03-19', endDate: '', activityName: '학부모 총회', gradeHours: { grade1: null, grade2: null, grade3: null, grade4: null, grade5: null, grade6: null }, subject: '-', notes: '' },
  ...
  { month: 4, startDate: '2026-04-15', endDate: '', activityName: '학부모 공개수업', gradeHours: { grade1: 1, grade2: 1, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '교과 또는 창체', notes: '' },
  { month: 4, startDate: '2026-04-17', endDate: '', activityName: '장애이해교육(1교시)', gradeHours: { grade1: 1, grade2: 1, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '교과 또는 창체', notes: '' },
  ...
  { month: 4, startDate: '2026-04-30', endDate: '', activityName: '공동체험의 날 (대박달콤)', gradeHours: { grade1: 3, grade2: 3, grade3: 3, grade4: 3, grade5: 3, grade6: 3 }, subject: '체육 또는 창체', notes: '' },
  ...
  { month: 6, startDate: '2026-06-23', endDate: '', activityName: '합동소방훈련', gradeHours: { grade1: 1, grade2: 1, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '창체(자율자치)', notes: '소방서 일정에 따라 변동됨' },
  ...
  { month: 7, startDate: '2026-07-21', endDate: '', activityName: '2학기 학급자치임원 선거', gradeHours: { grade1: null, grade2: null, grade3: 2, grade4: 2, grade5: 2, grade6: 2 }, subject: '창체(자율자치)', notes: '' },
  { month: 7, startDate: '2026-07-28', endDate: '', activityName: '여름방학식(4교시)', gradeHours: { grade1: 1, grade2: 1, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '창체(자율자치)', notes: '1~6학년 4교시 편성(급식 실시)' },
  { month: 8, startDate: '2026-08-20', endDate: '', activityName: '여름방학 개학식(1교시)', gradeHours: { grade1: 1, grade2: 1, grade3: 1, grade4: 1, grade5: 1, grade6: 1 }, subject: '창체(자율자치)', notes: '1~6학년 4교시 편성(급식실시)' },
  ...
  { month: 10, startDate: '2026-10-22', endDate: '', activityName: '교육동행의 날', gradeHours: { grade1: 4, grade2: 4, grade3: 4, grade4: 4, grade5: 4, grade6: 4 }, subject: '교과 또는 창체', notes: '' },
  ...
  { month: 11, startDate: '2026-11-12', endDate: '', activityName: '진로체험 한마당(1~4교시)', gradeHours: { grade1: 4, grade2: 4, grade3: 4, grade4: 4, grade5: 4, grade6: 4 }, subject: '창체(진로)', notes: '미정' },
  ...
  { month: 12, startDate: '2026-12-10', endDate: '', activityName: '2027학년도 전교임원 선거(1~2교시)', gradeHours: { grade1: null, grade2: null, grade3: 2, grade4: 2, grade5: 2, grade6: null }, subject: '창체(자율자치)', notes: '' },
  { month: 12, startDate: '2026-12-31', endDate: '', activityName: '종업식 및 졸업식', gradeHours: { grade1: 2, grade2: 2, grade3: 2, grade4: 2, grade5: 2, grade6: 3 }, subject: '창체(자율자치)', notes: '1~5학년 2교시 편성, 6학년 3교시 편성, 급식미실시' },
];
